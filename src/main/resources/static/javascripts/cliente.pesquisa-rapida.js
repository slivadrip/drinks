...
Drinks.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new Drinks.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
Drinks.TabelaClientePesquisaRapida = (function() {
...
$(function() {
	var pesquisaRapidaCliente = new Drinks.PesquisaRapidaCliente();
