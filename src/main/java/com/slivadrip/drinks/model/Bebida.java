package com.slivadrip.drinks.model;
...
import com.slivadrip.drinks.validation.SKU;
@Entity
@Table(name = "bebida")
public class Bebida {
	...
	// varias cervejas podem ter 1 estilo
	...
	@PrePersist @PreUpdate //antes de persiste e antes de fazaer update ele ira executar esse metodo
	...
	public String getFotoOuMock() {
		return !StringUtils.isEmpty(foto) ? foto : "bebida-mock.png";
	}
