...
import com.slivadrip.drinks.repository.paginacao.PaginacaoUtil;
...
public class BebidasImpl implements BebidasQueries {
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new com.slivadrip.drinks.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Bebida";
	...
	private boolean isEstiloPresente(BebidaFilter filtro) {
		return filtro.getEstilo() != null && filtro.getEstilo().getCodigo() != null;
	}

	@Override
	public List<BebidaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new com.slivadrip.drinks.dto.BebidaDTO(codigo, sku, nome, origem, valor, foto) "
				+ "from Bebida where lower(sku) like lower(:skuOuNome) or lower(nome) like lower(:skuOuNome)";
		List<BebidaDTO> cervejasFiltradas = manager.createQuery(jpql, BebidaDTO.class)
